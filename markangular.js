...
},{"./compile":5,"./controller":6,"./directives/ng_click":7,"./directives/ng_controller":8,"./directives/ng_transclude":9,"./filter":10,"./http":13,"./http_backend":14,"./interpolate":16,"./loader":17,"./parse":18,"./q":19,"./scope":20}],4:[function(require,module,exports){
/**
...
},{"./angular_public":3,"./injector":15,"jquery":1,"lodash":2}],5:[function(require,module,exports){
'use strict';
var _ = require('lodash');
var $ = require('jquery');
...
},{"./filter_filter":11,"lodash":2}],11:[function(require,module,exports){
/**
...
},{"lodash":2}],12:[function(require,module,exports){
/**
 * Created by fengchaoyi on 16/1/4.
 */
'use strict';
...
},{"./hash_map":12,"lodash":2}],16:[function(require,module,exports){
/**
...
//chapter 9
// a watcher that behaves like any other watcher, except that it removes itself immediately upon first invocation
function constantWatchDelegate(scope, listenerFn, valueEq, watchFn){
    var unwatch = scope.$watch(
        function(){ //wrap in a function with no $$watchDelegate
...
function oneTimeWatchDelegate(scope, listenerFn, valueEq, watchFn){
    ...
    var unwatch = scope.$watch(
        ...
        function(newValue, oldValue, scope){
            ...
            if (!_.isUndefined(newValue)){  //the watcher should be removed when the value becomes not undefined
...
function oneTimeLiteralWatchDelegate(scope, listenerFn, valueEq, watchFn){  //only applied for arrays and objects
...
ASTCompiler.prototype.compile = function(text){
    ...
    if (!assignable) {
        ...
        extra = 'fn.assign = function(s,v,l){' + (this.state.assign.vars.length ? 'var ' + this.state.assign.vars.join(',') + ';' : '') + this.state.assign.body.join('') + '};';
    }
    this.stage = 'main';
    ...
    var fn = new Function('ensureSafeMemberName', 'ensureSafeObject', 'ensureSafeFunction', 'ifDefined', 'filter',
        fnString)(ensureSafeMemberName, ensureSafeObject, ensureSafeFunction, ifDefined, this.$filter);
    /* jshint +W054 */
...
function markConstantAndWatchExpressions(ast, $filter){
    ...
    switch (ast.type){
        ...
        case AST.Literal:
            ast.constant = true;
            ast.toWatch = [];   //nothing to watch for literals
            break;
        case AST.Identifier:
            ast.constant = false;
            ast.toWatch = [ast];
...
function isAssignable(ast){
    return ast.type === AST.MemberExpression || ast.type === AST.Identifier;
}
